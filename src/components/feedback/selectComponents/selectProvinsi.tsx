...
import { ResReferensiType, useGetProvinsiQuery } from './data'
...
export function SelectProvinsi({
  name,
  headerLabel,
  placeholder,
  isDisabled,
  ...
  const [listProvinsi, setListProvinsi] = useState<ResReferensiType[]>([])
              ...
              <FormControl>
                <Select
                  ...
                  onChange={(optionSelected) => {
                    ...
                    form.setValue('provinsi_id', optionSelected.value)
                    form.setValue('kabupaten_id', null)
